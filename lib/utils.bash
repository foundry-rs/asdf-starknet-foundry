...
GH_NIGHTLIES_REPO="https://github.com/foundry-rs/starknet-foundry-nightlies"
...
# NOTE: You might want to remove this if starknet-foundry is not hosted on GitHub releases.
